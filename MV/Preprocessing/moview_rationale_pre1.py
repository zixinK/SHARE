...
from Preprocessing.connected_shapley1 import explain_shapley, construct_positions_connectedshapley,explain_shapley_no
...
def convert_fn(examples, tokenizer, label_list,classifier,neighbor, max_length=None, verbose=True):
    ...
    for example in tqdm.tqdm(examples, "converting to features"):
        ...
        score1 = [0] + score1 + [0] * (max_length - int(torch.Tensor(evidence_mask).sum(dim=0)) - 1)
